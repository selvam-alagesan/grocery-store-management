...
export default function EmployeeModal(props) {
    ...
    const handleSubmit = async(e) =>{
        ...
        try{
            ...
            const response = await  API.post('/admin/employeeRegister', employee);
    ...
    >
      ...
      <Row className="mb-3">
        ...
        <Form.Group as={Col} controlId="formGridPassword">
          ...
          <Form.Control type="password" name="password" required onChange={handleChange} placeholder="Password" value={formData.password} />
        </Form.Group>
      </Row>
        <Row>
      <Form.Group as={Col}  className="mb-3" controlId="formGridAddress1">
        <Form.Label>Name</Form.Label>
        <Form.Control placeholder="Name" name="name" onChange={handleChange} required value={formData.name} />
      </Form.Group>
      ...
      <Row className="mb-3">
       ...
       <Row className="mb-3">
        <Form.Group as={Col} >
          ...
          <Form.Control type='text' name="aadharno" value={formData.aadharno} onChange={handleChange} placeholder='enteryour aadharnumber' minLength={12} maxLength={12} required pattern="[0-9]{12}"/>
        </Form.Group>

       
        <Form.Group as={Col}>
          <Form.Label>Salary</Form.Label>
          <Form.Control type='number' name="salary" value={formData.salary} onChange={handleChange} placeholder='enter your salary'/>
        </Form.Group>
      </Row>
        <Row>
          <Form.Group as={Col} >
