  ...
  return (
    ...
    >
      ...
      <Modal.Body>
          ...
          {/* Employee deltail section */}
              ...
              <Row className="mb-3">
                <Form.Group as={Col} controlId="formGridEmail">
                  ...
                  <Form.Control type="text" name='employeeusername'  value={props.user.employeeusername}  disabled/>
                </Form.Group>
        ...
        <Form.Control placeholder="Name" name="employeename"  value={props.user.employeename} disabled />
      </Form.Group>
