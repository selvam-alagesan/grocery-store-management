...
import styles from './SupAttendence.module.css'

export default function SupAttendence() {
  ...
  return (
    <div>
        <h1 style={{backgroundColor:" rgb(23, 85, 109)",color:'white'}}>Attendence</h1>
...
<br /><br />
       {thisMon ? ( <div className={styles.tablediv}>
            ...
            {thisMonth.length===0?(<>No attendence marked this month</>):(<table style={{width:'500px'}}>
                <thead>
                    <tr>
                        <th>
                            Date
        ...
        {oldMonth ?( <div className={styles.tablediv}>
           {user?.attendence.length===0?(<>No attendence Marked</>):( <table style={{width:'500px'}}>
                <thead>
                    <tr>
                        <th>
                            Date
